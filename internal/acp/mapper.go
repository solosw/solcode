...
func availableCommands() []AvailableCommand {
	return []AvailableCommand{
		...
		{Name: "checkpoints", Description: "List code checkpoints for the current session"},
		{Name: "checkpoint-name", Description: "Label a checkpoint", Input: &AvailableCommandInput{Hint: "name [turn]"}},
		{Name: "rewind", Description: "Restore workspace files to a previous turn (code only)", Input: &AvailableCommandInput{Hint: "turn | name"}},
